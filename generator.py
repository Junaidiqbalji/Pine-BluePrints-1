...
def generate_premium_pdf(plan_json_str, page_to_images=None, docx_images_dict=None, output_filename="Premium_Plan.docx", custom_img_dir=None):
    """
    Generates an elegantly styled DOCX file aligned with Pine BluePrints branding.
    """
    ...
    # Branded text
    run_brand = footer_p.add_run("Pine BluePrints  |  ")
    ...
    brand_run = brand_p.add_run("GENERATED BY PINE BLUEPRINTS")
